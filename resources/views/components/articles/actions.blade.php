        ...
        @can(App\Policies\ArticlePolicy::UPDATE, $article)
            ...
            >
                <span class="flex items-center gap-x-2">
                    ...
                    <span x-cloak x-show="hovered === 'edit'" class="leading-5">Editar artículo</span>
                </span>
            </x-buttons.secondary-button>
        @endcan
            ...
            @can(App\Policies\ArticlePolicy::APPROVE, $article)
                ...
                >
                    <span class="flex items-center gap-x-2">
                        ...
                        <span x-cloak x-show="hovered === 'publish'" class="leading-5">Publicar artículo</span>
                    </span>
                </x-buttons.secondary-button>
            @endcan
            ...
            @can(App\Policies\ArticlePolicy::DECLINE, $article)
                ...
                >
                    <span class="flex items-center gap-x-2">
                        ...
                        <span x-cloak x-show="hovered === 'decline'" class="leading-5">Rechar artículo</span>
                    </span>
                </x-buttons.secondary-button>
            @endcan
        @else
            @can(App\Policies\ArticlePolicy::DISAPPROVE, $article)
                ...
                >
                    <span class="flex items-center gap-x-2">
                        ...
                        <span x-cloak x-show="hovered === 'unpublish'" class="leading-5">Anular publicación</span>
                    </span>
                </x-buttons.secondary-button>
            @endcan
        @endif
        ...
        @can(App\Policies\ArticlePolicy::PINNED, $article)
            ...
            >
                <span class="flex items-center gap-x-2">
                    ...
                    <span x-cloak x-show="hovered === 'pin'" class="leading-5">{{ $article->isPinned() ? 'Desenganchar artículo' : 'Fijar artículo' }}</span>
                </span>
            </x-buttons.secondary-button>
        @endcan
    </div>
    ...
    @can(App\Policies\ArticlePolicy::DELETE, $article)
        ...
        >
            <span class="flex items-center gap-x-2">
                ...
                <span x-cloak x-show="hovered === 'delete'" class="leading-5">Eliminar artículo</span>
            </span>
        </x-buttons.danger-button>
    @endcan
</div>
