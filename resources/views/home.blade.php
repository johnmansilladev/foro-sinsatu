...
<section>
    <div class="w-full px-12 py-4 flex">
        <div class="w-3/8">
            <div class="p-4 w-full max-w-sm bg-white rounded-lg border shadow-md sm:p-6 mx-auto px-4 sm:px-6 lg:px-8 bg-white rounded-lg border shadow-md sm:p-6 dark:bg-slate-800 dark:border-slate-800">
                ...
                <ul class="my-4 space-y-3">
                    ...
                    <li>
                        <a href="#" class="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">Forums</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                    ...
                    <li>
                        <a href="#" class="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">Selling</span>
                        </a>
                    </li>
                    <li>
                        <a href="#" class="flex items-center p-3 text-base font-bold text-gray-900 bg-gray-50 rounded-lg hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                            <svg aria-hidden="true" class="h-4" viewBox="0 0 96 96" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M72.0998 0.600098H48.3998H24.5998H0.799805V24.4001V48.2001V49.7001V71.8001V71.9001V95.5001H24.5998V72.0001V71.9001V49.8001V48.3001V24.5001H48.3998H72.1998H95.9998V0.700104H72.0998V0.600098Z" fill="#617BFF"></path>
                            ...
                            <span class="flex-1 ml-3 whitespace-nowrap">Shared links</span>
                        </a>
                    </li>
                </ul>
                <div>
        ...
        <div class="block w-full w-5/8 px-6">
