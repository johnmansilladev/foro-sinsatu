...
<section class="dark:bg-slate-900">
    <div class="bg-slate-900 dark:bg-gray-600 bg-contain h-60 w-full" style="background-image: url('{{ asset('images/profile-background.svg') }}')"></div>
    ...
    <div class="container mx-auto">
        ...
        <div class="flex flex-col mt-5 p-4 lg:flex-row lg:gap-x-12">
            <div class="w-full mb-10 lg:w-1/3 lg:mb-0">
                <div class="text-gray-900 bg-gray-100 dark:bg-inherit dark:text-white">
                ...
                <div class="mt-4">
                    <span class="text-gray-900 bg-gray-100 dark:bg-inherit dark:text-white">
                        {{ $user->bio() }}
                    </span>
                </div>

                <div class="mt-4 mb-6 flex items-center gap-x-3 dark:text-white">
    ...
    <div class="container mx-auto  my-4 lg:my-8 mb-4" x-data="{ tab: 'threads' }">
        <div class="container mx-auto">
        ...
        <div class="mt-6 bg-inherit dark:bg-slate-800 py-14  px-12 rounded">
            <div class="container mx-auto">
